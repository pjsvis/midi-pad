<script lang="typescript">
    ...
    // Ref: https://codepen.io/blucube/pen/cudAz
...
@import url(https://fonts.googleapis.com/css?family=Varela+Round|Open+Sans:300);
 ...
 .knob-surround {
	 ...
	 -webkit-box-shadow: 0 .2em .1em .05em rgba(255,255,255,0.1) inset, 0 -0.2em .1em .05em rgba(0,0,0,0.5) inset, 0 .5em .65em 0 rgba(0,0,0,0.3);
	 -moz-box-shadow: 0 .2em .1em .05em rgba(255,255,255,0.1) inset, 0 -0.2em .1em .05em rgba(0,0,0,0.5) inset, 0 .5em .65em 0 rgba(0,0,0,0.3);
	 box-shadow: 0 .2em .1em .05em rgba(255,255,255,0.1) inset, 0 -0.2em .1em .05em rgba(0,0,0,0.5) inset, 0 .5em .65em 0 rgba(0,0,0,0.3);
}
 .knob {
	 position: absolute;
	 width: 100%;
 ...
 .knob:before {
	 ...
	 border-radius: 50%;
	 -webkit-box-shadow: 0 0 .4em 0 #79c3f4;
	 -moz-box-shadow: 0 0 .4em 0 #79c3f4;
	 box-shadow: 0 0 .4em 0 #79c3f4;
}
 .min, .max {
	 display: block;
 ...
 .activetick:after {
	 background-color: #a8d8f8;
	 -webkit-box-shadow: 0 0 .3em .08em #79c3f4;
	 -moz-box-shadow: 0 0 .3em .08em #79c3f4;
	 box-shadow: 0 0 .3em .08em #79c3f4;
